...
//#define	LCD_RS LATD4 		// RS afficheur	
//#define	LCD_RW LATD5 		// R/W afficheur
//#define       LCD_EN LATD6 		// EN afficheur
//#define	LCD_PWR LATD7		// alimentation de l'afficheur
//#define       LCD_DATA LATD		// port D complet dont <D3:D0> 4 bits de données
...
void lcd_write(char c)
{
    ...
    LCD_EN = 0;
    LCD_RW = 0;
                                        // RS est affect? avant de lancer cette fonction !
    ...
    Ln = (c << 4) | (LCD_DATA & 0x0F);			// masuage des bits de poids fort pour ne conserver que le poids faible
    LCD_EN = 0;
    LCD_RW = 0;
...
void lcd_init()
{
    ...
    LCD_DATA = 0x30  | (LCD_DATA & 0x0F);		// LCD_DATA=D7.D6.D5.D4.0.0.0.0
    LCD_EN   = 0;
    LCD_RW   = 0;
    LCD_RS   = 0;
    LCD_PWR  = 1;
    ...
    LCD_DATA = 0x20 | (LCD_DATA & 0x0F);		// d'apr?s notice
    LCD_EN   = 0;
    LCD_RW   = 0;
    LCD_RS   = 0;
    LCD_PWR  = 1;
